...
# REPOSITORY INFO
set  :scm, :git
set  :repository,  "git://github.com/bsherman26/EagleEco"

# SERVER INFO
set  :deploy_to, "/apps/EagleEco"            # Change from the default deploy directory ("/u/apps/#{application}")
set  :user, "eagleeco"                                 # This is not necessary, but if the user name was different it is needed
